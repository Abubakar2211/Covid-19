...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $email = $_POST['email'];
        $pass = $_POST['password'];
        $query = "insert into tbladmin(AdminName,AdminuserName,MobileNumber,Email,Password) values('Admin','$fname','$mnumber','$email','$pass')";
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" class="form-control" id="email" name="email" placeholder="Please enter your email" required="true" onBlur="empidAvailability()">
                                                <span id="email-availability-status" style="font-size:12px;"></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Password</label>
                                                <input type="text" class="form-control" id="text" name="password" placeholder="Please enter your password number"  required="true">
                                            </div>
